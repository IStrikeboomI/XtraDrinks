...
public class XtraDrinksFluids {
    ...
    public static final RegistryObject<FluidType> MOLTEN_FIZZIUM_TYPE = registerFluidType("molten_fizzium",new ResourceLocation(XtraDrinks.MOD_ID,"block/molten_fizzium_still"),new ResourceLocation(XtraDrinks.MOD_ID,"block/molten_fizzium_flowing"),0xfaaa39);
    ...
    public static final RegistryObject<FluidType> MOLTEN_LIQUADIUM_TYPE = registerFluidType("molten_liquadium",new ResourceLocation(XtraDrinks.MOD_ID,"block/molten_liquadium_still"),new ResourceLocation(XtraDrinks.MOD_ID,"block/molten_liquadium_flowing"),0x4fb8e8);
    ...
    public static final RegistryObject<FluidType> MOLTEN_JUICETANIUM_TYPE = registerFluidType("molten_juicetanium",new ResourceLocation(XtraDrinks.MOD_ID,"block/molten_juicetanium_still"),new ResourceLocation(XtraDrinks.MOD_ID,"block/molten_juicetanium_flowing"),0x2ccf17);
    ...
    public static RegistryObject<FluidType> registerFluidType(String name, ResourceLocation still, ResourceLocation flowing, int tint) {
