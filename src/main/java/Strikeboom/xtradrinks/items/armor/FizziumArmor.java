...
public class FizziumArmor extends ArmorItem {
    public FizziumArmor(IArmorMaterial pMaterial, EquipmentSlotType pSlot) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable World pWorld, List<ITextComponent> pTooltipComponents, ITooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(new TranslationTextComponent("item." + XtraDrinks.MOD_ID + ".tooltip.fizzium_armor").withStyle(TextFormatting.YELLOW));
    }
    ...
    public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
        ...
        if (ArmourPieces == 4) {
            player.addEffect(new EffectInstance(Effects.MOVEMENT_SPEED, 40,1));
        }
    }
}
