...
public class PlantableFruit extends BlockNamedItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable World pWorld, List<ITextComponent> pTooltipComponents, ITooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(new TranslationTextComponent("item." + XtraDrinks.MOD_ID + ".tooltip.crop").withStyle(TextFormatting.GREEN));
    }
}
